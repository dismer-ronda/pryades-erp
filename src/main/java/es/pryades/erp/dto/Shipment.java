...
public class Shipment extends BaseDto
{
	...
	private static final String CLASS_DIV_LEYEND_LEFT	=  "text_regular_size text_bold padding_left padding_right padding_top padding_bottom";
	private static final String CLASS_DIV_LEYEND_RIGHT	=  "text_regular_size padding_left padding_right padding_top padding_bottom";
	...
	public String getPackingTable( AppContext ctx )
	{
		...
		String headers = "";
		headers += XmlUtils.getTableCol( "", "text_regular_size text_center text_bold borde", ctx.getString( "template.shipment.packing.invoices" ) );
		headers += XmlUtils.getTableCol( "", "text_regular_size text_center borde", getInvoices( ctx ) );
		headers += XmlUtils.getTableCol( "", "text_regular_size text_center text_bold borde", ctx.getString( "template.shipment.packing.orders" ) );
		headers += XmlUtils.getTableCol( "", "text_regular_size text_center borde", getOrders( ctx ) );
		...
		for ( ShipmentBox box : boxes )
		{
			...
			row += XmlUtils.getTableCol( "44px", "text_regular_size text_center borde", box.getGrossWeight().toString() );
		...
		footers += XmlUtils.getTableCol( "44px", "", XmlUtils.getDiv( "text_regular_size text_center padding_v text_bold", getGrossWeight().toString() ) );
		...
		ret += XmlUtils.getTable( "100%", "border_no_spacing", XmlUtils.getTableRow( "", leyends ) );
