...
public class PurchasePaymentResource extends ServerResource 
{
	private static final Logger LOG = Logger.getLogger( PurchasePaymentResource.class );
				...
				rep = new OutputRepresentation(MediaType.APPLICATION_PDF) 
				{
					...
					public void write( OutputStream arg0 ) throws IOException
					{
						try
						{
							...
							arg0.write( purchase.getPayment() );
						}
						catch ( Throwable e )
						{
