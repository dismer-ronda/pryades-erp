...
import es.pryades.erp.reports.PdfExportPurchases;
import es.pryades.erp.services.Return;
import es.pryades.erp.services.ReturnFactory;

public class PurchasesResource extends ServerResource 
{
	private static final Logger LOG = Logger.getLogger( PurchasesResource.class );
				...
				rep = new OutputRepresentation(MediaType.APPLICATION_PDF) 
				{
					...
					public void write( OutputStream arg0 ) throws IOException
					{
						try
						{
							...
							PdfExportPurchases export = new PdfExportPurchases( purchases, query );
