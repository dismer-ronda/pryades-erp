...
public class PurchaseQuotationResource extends ServerResource 
{
	private static final Logger LOG = Logger.getLogger( PurchaseQuotationResource.class );
				...
				rep = new OutputRepresentation(MediaType.APPLICATION_PDF) 
				{
					...
					public void write( OutputStream arg0 ) throws IOException
					{
						try
						{
							...
							Purchase purchase = (Purchase)IOCManager._PurchasesManager.getRow( ctx, query );
							
							arg0.write( purchase.getQuotation() );
						}
						catch ( Throwable e )
						{
