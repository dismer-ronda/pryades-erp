...
public class PurchaseInvoiceResource extends ServerResource 
{
	private static final Logger LOG = Logger.getLogger( PurchaseInvoiceResource.class );
				...
				rep = new OutputRepresentation(MediaType.APPLICATION_PDF) 
				{
					...
					public void write( OutputStream arg0 ) throws IOException
					{
						try
						{
							...
							arg0.write( purchase.getInvoice() );
						}
						catch ( Throwable e )
						{
